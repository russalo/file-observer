...
{
  "schema_version": "1.25",
  "context": { "scanner_version": "1.48.0", "logic_version": "1.25.0", "...": "…" },
  "files": [
    {
...
```yaml
- uses: russalo/file-observer@v1.48.0     # pin a release tag
  id: scan
  with:
