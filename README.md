...
{
  "schema_version": "1.23",
  "context": { "scanner_version": "1.44.0", "logic_version": "1.22.0", "...": "…" },
  "files": [
    {
...
```yaml
- uses: russalo/file-observer@v1.44.0     # pin a release tag
  id: scan
  with:
