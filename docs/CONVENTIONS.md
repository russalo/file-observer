...
|---|---|---|---|---|
| Package release | `SCANNER_VERSION` | `MAJOR.MINOR.PATCH` | 1.35.0 | Internal |
| Routing logic | `LOGIC_VERSION` | `MAJOR.MINOR.PATCH` | 1.19.0 | Internal* |
| Manifest shape | `SCHEMA_VERSION` | `MAJOR.MINOR` | 1.21 | **Public** |
