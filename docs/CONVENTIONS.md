...
**Current vectors:**
- `chatlog` method_version: 4 (v1.2: generalized conversational JSON/JSONL detection — role/content keys, arrays, nested trees, embedded dialogue, `.json` candidate; markdown FP co-signal; per-speaker structure. Prior: 3 = v0.10.1 JSONL role detection + v0.9.1 stop-list/H3 threshold)
