...
|---|---|---|---|---|
| Package release | `SCANNER_VERSION` | `MAJOR.MINOR.PATCH` | 1.34.0 | Internal |
| Routing logic | `LOGIC_VERSION` | `MAJOR.MINOR.PATCH` | 1.18.0 | Internal* |
| Manifest shape | `SCHEMA_VERSION` | `MAJOR.MINOR` | 1.20 | **Public** |
