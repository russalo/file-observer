...
| `0.11` | 0.11.0 | Provisional → stable promotions: `vectors_collected[]`, `reference_tokens`, `per_directory_summary[]`, `email.body_chatlog`, `filename_patterns`. SECURITY.md added. No new fields. |
