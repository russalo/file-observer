...
| 0.11.0 | 0.11 | 2026-05-27 | Provisional → stable promotions: `vectors_collected[]`, `reference_tokens`, `per_directory_summary[]`, `email.body_chatlog`, `filename_patterns` all promoted from §2.4 Internal Field Sets to stable. SECURITY.md added (observation-only scope, vulnerability reporting, dependency security, bounded observation). No new features, no new fields. SCHEMA_VERSION 0.10 → 0.11. | [v0.11.0_RFC_Specification.md](v0.11.0_RFC_Specification.md) | _(pending)_ |
