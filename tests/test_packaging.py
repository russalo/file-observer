...
def test_canonical_top_level_api():
    ...
    assert file_observer.__version__ == "1.7.0"
...
def test_canonical_submodule_constants_unchanged():
    ...
    assert SCHEMA_VERSION == "1.6"  # v1.7.0 additive: provisional pdf.xref_type
    assert LOGIC_VERSION == "1.4.0"  # unchanged at v1.7 (structural-anchor reads are extraction, not routing)
