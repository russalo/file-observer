...
def test_canonical_submodule_constants_unchanged():
    ...
    assert SCHEMA_VERSION == "1.16"  # unchanged at v1.26.0 (one-call API is a Python surface, not the manifest)
    assert LOGIC_VERSION == "1.14.1"  # unchanged at v1.26.0 (no routing change)
