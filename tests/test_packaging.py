...
def test_canonical_top_level_api():
    ...
    assert file_observer.__version__ == "1.4.0"
...
def test_canonical_submodule_constants_unchanged():
    ...
    assert SCHEMA_VERSION == "1.3"  # v1.4.0 additive: provisional content_shape fields
    assert LOGIC_VERSION == "1.3.0"  # v1.4.0: content-shape chatlog detection gate
