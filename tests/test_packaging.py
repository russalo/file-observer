...
def test_canonical_submodule_constants_unchanged():
    ...
    assert SCANNER_VERSION == "1.46.4"
    assert SCHEMA_VERSION == "1.23"  # v1.46.4 — FROZEN (recognition patch; no new manifest field). Prior 1.23 = v1.41.0 additive lexicon_match.metadata
    assert LOGIC_VERSION == "1.24.3"  # v1.46.4 — recognition change: .DS_Store/AppleDouble recognized by magic (unsupported_extension flips; v1.22/v1.23.3 precedent)
