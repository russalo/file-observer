...
def test_canonical_top_level_api():
    ...
    assert file_observer.__version__ == "1.10.0"
...
def test_canonical_submodule_constants_unchanged():
    ...
    assert SCANNER_VERSION == "1.10.0"
    assert SCHEMA_VERSION == "1.8"  # v1.10.0: promotions + new provisional fields
    assert LOGIC_VERSION == "1.4.3"  # v1.9.1 — stat-failure path preserved
