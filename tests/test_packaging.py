...
def test_canonical_top_level_api():
    ...
    assert file_observer.__version__ == "1.8.1"
...
def test_canonical_submodule_constants_unchanged():
    ...
    assert SCANNER_VERSION == "1.8.1"
    assert SCHEMA_VERSION == "1.7"  # v1.8.0 additive: provisional pdf.parser
    assert LOGIC_VERSION == "1.4.1"  # v1.8.1 — red-team hardening (discovery + error-handling behavior change)
